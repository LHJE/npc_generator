...
describe Proficiencies do
  ...
  it "exists" do
    proficiencies = Proficiencies.new(@data)

    expect(proficiencies).to be_a(Proficiencies)
    expect(proficiencies.armor).to be_a(String)
    expect(proficiencies.weapons).to be_a(String)
    expect(proficiencies.tools).to be_a(String)
  end
