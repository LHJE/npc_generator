...
ng as the student grows more adept. Thus, a monk need choose a tradition only upon reaching 3rd level.",
 ...
 :document__license_url=>"http://open5e.com/legal"}]
  ...
  it "exists" do
    ...
    expect(npc.stats.core_stats.stats[:str_mod]).to be_a(Integer)
    expect(npc.stats.core_stats.stats[:dex_mod]).to be_a(Integer)
    expect(npc.stats.core_stats.stats[:con_mod]).to be_a(Integer)
    expect(npc.stats.core_stats.stats[:int_mod]).to be_a(Integer)
    expect(npc.stats.core_stats.stats[:wis_mod]).to be_a(Integer)
    expect(npc.stats.core_stats.stats[:cha_mod]).to be_a(Integer)
